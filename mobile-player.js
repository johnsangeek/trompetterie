...
(()=>{
  ...
  const names=["Do","Do♯","Ré","Mi♭","Mi","Fa","Fa♯","Sol","La♭","La","Si♭","Si"],fingering=[[],[1,2,3],[1,3],[2,3],[1,2],[1],[2],[],[2,3],[1,2],[1],[2]],scales={blues:[0,3,5,6,7,10,12],major:[0,2,4,5,7,9,11,12],minor:[0,2,3,5,7,8,10,12],pentatonic:[0,2,4,7,9,12],minorPentatonic:[0,3,5,7,10,12]},scaleNames={blues:"Blues",major:"Majeure",minor:"Mineure",pentatonic:"Pentatonique majeure",minorPentatonic:"Pentatonique mineure"};
  ...
  function loadScale(){const root=Number(params.get("root")||2),key=params.get("scale")||"blues",base=(60+root>71?48:60)+root,seq=[...scales[key],...scales[key].slice(0,-1).reverse()];const melody=seq.map((n,i)=>({beat:i,note:base+n,duration:.82,guide:true}));song={melody,all:melody,endBeat:seq.length,bpm:92};$("#mpTitle").textContent=`Gamme ${scaleNames[key]} · ${names[root]}`}
